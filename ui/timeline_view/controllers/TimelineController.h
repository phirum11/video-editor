...
public:
    ...
    Q_INVOKABLE int addEffectClip(const QString& name, const QString& thumbnailPath, const ClipEffects& effects, double startSeconds, double durationSeconds, int trackIndex);
...
public:
    void autoRippleTrack(int trackIndex);
    bool m_isAutoRippling = false;
